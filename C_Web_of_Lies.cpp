...
void solve()
{
    ...
    while (q--)
    {
        ...
        if (type == 1)
        {
            ...
            int v;
            cin >> u >> v;
            int prevbig=*mpp[u].rbegin();
            mpp[u].insert(v);
            int currbig=*mpp[v].rbegin();
            if(prevbig<=u && currbig>u)
            {
                ans--;
            }
            prevbig=*mpp[v].rbegin();
            mpp[v].insert(u);
            currbig=*mpp[v].rbegin();
            if(prevbig<=v && currbig>v)
            {
                ans--;
            }
        }
