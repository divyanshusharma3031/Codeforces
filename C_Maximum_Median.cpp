...
bool check(int mid,vector<int> &arr,int k)
{
    ...
    int x=n/2;
    int r=upper_bound(arr.begin(),arr.end(),mid)-arr.begin();
    int sum=pref[r]-pref[x];
    int req=mid*(r-x)-sum;
    return req<=k;
}
void solve()
{
    ...
    // k can be upto 1e9 so linear increase wont work think of something better.

    // binary search can work
