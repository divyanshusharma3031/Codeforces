...
void solve()
{
    ...
    for (int i = 0; i < n; i++)
    {
        if (arr[i] % 2 == 0)
        {
            evens.push_back(arr[i] / 2); // for sure
        }
        else
        {
            odds.push_back(arr[i] / 2); // taking floor values.
        }
    }
    int s = 0;
    int s1 = 0;
